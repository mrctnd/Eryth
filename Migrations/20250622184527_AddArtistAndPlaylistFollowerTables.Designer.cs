...
namespace Eryth.Migrations
{
    ...
    [Migration("20250622184527_AddArtistAndPlaylistFollowerTables")]
    partial class AddArtistAndPlaylistFollowerTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eryth.Models.ArtistFollower", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eryth.Models.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eryth.Models.PlaylistFollower", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eryth.Models.Message", b =>
                {
                    b.HasOne("Eryth.Models.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Eryth.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Eryth.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Eryth.Models.Notification", b =>
                {
                    ...
                    b.HasOne("Eryth.Models.Message", "RelatedMessage")
                        .WithMany()
